...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
    <h2 class="text-xl font-bold text-gray-800 mb-6">Edit Role: {{ $role->name }}</h2>
    ...
    <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="name" value="{{ $role->name }}" class="shadow-sm border border-gray-200 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent" required>
