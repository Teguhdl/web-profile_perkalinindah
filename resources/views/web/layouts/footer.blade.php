...
<footer class="bg-[#3d3d3d] text-white py-6">
    <div class="container mx-auto max-w-screen-2xl px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 w-full">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    <a href="#" class="w-8 h-8 bg-white/10 rounded flex items-center justify-center hover:bg-blue-600 transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                            <path d="M18 2h-3c-1.7 0-3 1.3-3 3v3H9v4h3v10h4V12h3l1-4h-4V5c0-.3.2-1 1-1h3V2z" />
                        </svg>
                    </a>
                    <a href="#" class="w-8 h-8 bg-white/10 rounded flex items-center justify-center hover:bg-pink-600 transition">
                    ...
                    <a href="#" class="w-8 h-8 bg-white/10 rounded flex items-center justify-center hover:bg-gray-700 transition">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div id="kontak">
                ...
                <ul class="space-y-3 text-gray-300 text-sm">
                    <li class="flex items-start">
                        ...
                        <span>www.ptperkalinindah.com</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 mr-2 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span>Jl. Cibeurying, Wanilan, Subang, Kabupaten Subang, Jawa Barat 41272</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 mr-2 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <span>(0260) 4641643</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 mr-2 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-col">
                            <span>marketing@perkalinindah.com</span>
                            <span>purchasing@perkalinindah.com</span>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-600 mt-8 pt-6 text-center text-gray-400 text-sm">
            <p>© 2025 PT. Perkalinindah. All rights reserved.</p>
        </div>
    </div>
</footer>